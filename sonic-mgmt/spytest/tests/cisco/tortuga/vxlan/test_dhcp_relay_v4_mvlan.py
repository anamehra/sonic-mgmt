...
def test_dhcp_relay_ipv4_mvlan_default_vrf_tc1():
    vars = st.get_testbed_vars()
...
def test_dhcp_relay_ipv4_mvlan_new_vrf_tc2():
    vars = st.get_testbed_vars()
...
def test_dhcp_relay_ipv4_mvlan_new_vrf_tc3():
    vars = st.get_testbed_vars()
...
def test_dhcp_relay_ipv4_mvlan_new_vrf_tc4():
    vars = st.get_testbed_vars()
...
def test_dhcp_relay_ipv4_mvlan_default_vrf_tc5():
    vars = st.get_testbed_vars()
...
def test_dhcp_relay_ipv4_mvlan_new_vrf_tc6():
    vars = st.get_testbed_vars()
